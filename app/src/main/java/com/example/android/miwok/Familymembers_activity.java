...
public class Familymembers_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_familymembers_activity);
        ...
        WordAdapter familyList = new WordAdapter(this, family);

        ListView listItem = (ListView) findViewById(R.id.familyListView);
        listItem.setAdapter(familyList);
        listItem.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Word word = family.get(position);
                MediaPlayer mediaPlayer = MediaPlayer.create(Familymembers_activity.this, word.getmSoundResourceID());
                mediaPlayer.start();
            }
        });
    }
